 ...
 */
 ...
 /*global console, requestAnimationFrame, cancelRequestAnimFrame, ActiveXObject, DOMParser, util*/
...
// taken from html5 boilerplate: http://html5boilerplate.com/
...
(function($, undefined) {
   ...
   /**
    ...
    function _init_ME() {
        ...
        me.XMLParser = new TinyXmlParser();
        ...
        api.collide = function(objB) {
            ...
            for ( var i = objCount, obj; i--;) {
                ...
                if (obj.visible && obj.collidable && obj.isEntity && (obj!=objB))
                {
                    ...
                    result = obj.checkCollision(objB);
                    if (result !== null) {
