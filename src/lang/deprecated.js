...
var deprecated = {
     ...
     */
    warning : function (deprecated, replacement, version) {
     ...
     */
     apply : function() {
        ...
        me.device.getPixelRatio = function() {
            me.deprecated.warning("me.device.getPixelRatio()", "me.device.devicePixelRatio", "5.1.0");
        ...
        me.Font = me.Text.extend({
            ...
            init: function (font, size, fillStyle, textAlign) {
                ...
                // deprecation warning
                me.deprecated.warning("me.Font", "me.Text", "6.1.0");
            },
        ...
        me.BitmapFont = me.BitmapText.extend({
            ...
            init: function (data, fontImage, scale, textAlign, textBaseline) {
                ...
                // deprecation warning
                me.deprecated.warning("me.BitmapFont", "me.BitmapText", "6.1.0");
            }
        });
        ...
        me.ScreenObject = me.Stage.extend({
            ...
            init: function (settings) {
                ...
                // deprecation warning
                me.deprecated.warning("me.ScreenObject", "me.Stage", "6.2.0");
            }
        });
        ...
        me.Renderer.prototype.drawShape = function () {
            me.deprecated.warning("drawShape()", "the stroke() or fill()", "6.3.0");
        ...
        me.video.getPos = function() {
            me.deprecated.warning("me.video.getPos()", "me.device.getElementBounds(me.video.renderer.getScreenCanvas());", "7.0.0");
        ...
        me.sys.checkVersion = function(first, second) {
            me.deprecated.warning("me.sys.checkVersion()", "me.utils.checkVersion()", "7.1.0");
        ...
        Object.defineProperty(me.game, "HASH", {
             ...
             */
            get : function () {
                me.deprecated.warning("me.game.HASH", "me.utils.getUriFragment()", "7.1.0");
        ...
        me.video.updateDisplaySize = function(x, y) {
            me.deprecated.warning("me.video.updateDisplaySize()", "me.video.scale()", "7.1.0");
        ...
        me.Renderer.prototype.scaleCanvas = function (x, y) {
            me.deprecated.warning("scaleCanvas()", "me.video.scale()", "7.1.0");
            return me.video.scale(x, y);
        };
        ...
        */
        me.Entity.prototype.distanceToPoint = function (v) {
            me.deprecated.warning("distanceToPoint()", "me.Renderable.distanceTo()", "7.1.0");
        ...
        */
        me.Entity.prototype.angleToPoint = function (v) {
            me.deprecated.warning("angleToPoint()", "me.Renderable.angleTo()", "7.1.0");
        ...
        Object.defineProperty(me.sys, "gravity", {
             ...
             */
            get : function () {
                me.deprecated.warning("me.sys.gravity", "me.game.world.gravity", "8.0.0");
        ...
        me.WebGLRenderer.Compositor.prototype.drawTriangle = function (points, len, strip) {
            ...
            me.deprecated.warning("drawTriangle()", "drawVertices()", "8.0.0");
        };
        ...
        me.WebGLRenderer.Compositor.prototype.drawLine = function (points, len, open) {
            ...
            me.deprecated.warning("drawLine()", "drawVertices()", "8.0.0");
        };
        ...
        Object.defineProperty(me.sys, "scale", {
             ...
             */
            get : function () {
                me.deprecated.warning("me.sys.scale", "me.video.scaleRatio", "8.0.0");
        ...
        me.video.getWrapper = function() {
            me.deprecated.warning("me.video.getWrapper()", "me.device.getParent()", "8.0.0");
        ...
        Object.defineProperty(me.sys, "fps", {
             ...
             */
            get : function () {
                me.deprecated.warning("me.sys.fps", "me.timer.maxfps", "8.0.0");
        ...
        Object.defineProperty(me.sys, "updatesPerSecond", {
             ...
             */
            get : function () {
                me.deprecated.warning("me.sys.updatesPerSecond", "me.game.world.fps", "8.0.0");
        ...
        Object.defineProperty(me.sys, "interpolation", {
             ...
             */
            get : function () {
                me.deprecated.warning("me.sys.interpolation", "me.timer.interpolation", "8.0.0");
        ...
        me.Body.prototype.addShapesFromJSON = function (json, id) {
            me.deprecated.warning("addShapesFromJSON()", "fromJSON()", "8.0.0");
        ...
        Object.defineProperty(me.sys, "stopOnAudioError", {
             ...
             */
            get : function () {
                me.deprecated.warning("me.sys.stopOnAudioError", "me.audio.stopOnAudioError", "9.0.0");
        ...
        Object.defineProperty(me.sys, "pauseOnBlur", {
             ...
             */
            get : function () {
                me.deprecated.warning("me.sys.pauseOnBlur", "me.device.pauseOnBlur", "9.0.0");
        ...
        Object.defineProperty(me.sys, "resumeOnFocus", {
             ...
             */
            get : function () {
                me.deprecated.warning("me.sys.pauseOnBlur", "me.device.resumeOnFocus", "9.0.0");
        ...
        Object.defineProperty(me.sys, "autoFocus", {
             ...
             */
            get : function () {
                me.deprecated.warning("me.sys.autoFocus", "me.device.autoFocus", "9.0.0");
        ...
        Object.defineProperty(me.sys, "stopOnBlur", {
             ...
             */
            get : function () {
                me.deprecated.warning("me.sys.pauseOnBlur", "me.device.stopOnBlur", "9.0.0");
        ...
        Object.defineProperty(me.sys, "preRender", {
             ...
             */
            get : function () {
                me.deprecated.warning("me.sys.preRender", "me.game.world.preRender", "9.0.0");
