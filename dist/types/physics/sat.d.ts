 ...
 */
export function testPolygonPolygon(a: Renderable | Container | Sprite | NineSliceSprite | Entity, polyA: Polygon, b: Renderable | Container | Sprite | NineSliceSprite | Entity, polyB: Polygon, response?: Response | undefined): boolean;
/**
 ...
 */
export function testEllipseEllipse(a: Renderable | Container | Sprite | NineSliceSprite | Entity, ellipseA: Ellipse, b: Renderable | Container | Sprite | NineSliceSprite | Entity, ellipseB: Ellipse, response?: Response | undefined): boolean;
/**
 ...
 * @returns {boolean} true if they intersect, false if they don't.
 */
export function testPolygonEllipse(a: Renderable | Container | Sprite | NineSliceSprite | Entity, polyA: Polygon, b: Renderable | Container | Sprite | NineSliceSprite | Entity, ellipseB: Ellipse, response?: Response | undefined): boolean;
/**
 ...
 * @returns {boolean} true if they intersect, false if they don't.
 */
export function testEllipsePolygon(a: Renderable | Container | Sprite | NineSliceSprite | Entity, ellipseA: Ellipse, b: Renderable | Container | Sprite | NineSliceSprite | Entity, polyB: Polygon, response?: Response | undefined): boolean;
