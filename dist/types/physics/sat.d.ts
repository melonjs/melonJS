 ...
 */
export function testPolygonPolygon(a: Renderable | Container | Sprite | Entity | NineSliceSprite, polyA: Polygon, b: Renderable | Container | Sprite | Entity | NineSliceSprite, polyB: Polygon, response?: Response | undefined): boolean;
/**
 ...
 */
export function testEllipseEllipse(a: Renderable | Container | Sprite | Entity | NineSliceSprite, ellipseA: Ellipse, b: Renderable | Container | Sprite | Entity | NineSliceSprite, ellipseB: Ellipse, response?: Response | undefined): boolean;
/**
 ...
 * @returns {boolean} true if they intersect, false if they don't.
 */
export function testPolygonEllipse(a: Renderable | Container | Sprite | Entity | NineSliceSprite, polyA: Polygon, b: Renderable | Container | Sprite | Entity | NineSliceSprite, ellipseB: Ellipse, response?: Response | undefined): boolean;
/**
 ...
 * @returns {boolean} true if they intersect, false if they don't.
 */
export function testEllipsePolygon(a: Renderable | Container | Sprite | Entity | NineSliceSprite, ellipseA: Ellipse, b: Renderable | Container | Sprite | Entity | NineSliceSprite, polyB: Polygon, response?: Response | undefined): boolean;
