...
describe("me.Vector2d", function () {
	...
	it("ceil/floor", function () {
		expect(
			new me.Vector2d(-0.1, 0.1).floorSelf().equals(new me.Vector2d(-1, 0)),
		).toEqual(true);
		expect(
			new me.Vector2d(-0.5, 0.5).floorSelf().equals(new me.Vector2d(-1, 0)),
		).toEqual(true);
		expect(
			new me.Vector2d(-0.9, 0.9).floorSelf().equals(new me.Vector2d(-1, 0)),
		).toEqual(true);
