(function() {
    ...
    pe.ShapeWidget.Helper = me.Renderable.extend({
        init : function(color) {
            this._super.init(new me.Vector2d(0, 0), 0, 0);
            this.z = Infinity;
            this.color = color;
        },
    ...
    pe.DragHandler = me.Renderable.extend({
        init : function(color) {
            ...
            this._super.init(new me.Vector2d(0, 0), this.originalSize, this.originalSize);
            this.z = Infinity;
            this.dragging = false;
    ...
    pe.VelocityWidget = pe.VectorWidget.extend({
        init : function() {
            this._super.init("velocity", new me.Color(229, 216, 47, 0.3));
            this.scale = 30;
        },
        onVectorChanged : function(vector) {
            var object = this.object;
    ...
    pe.ForceWidget = pe.VectorWidget.extend({
        init : function() {
            this._super.init("force", new me.Color(79, 214, 72, 0.3));
            this.scale = 300;
        },
        onVectorChanged : function(vector) {
            var object = this.object;
