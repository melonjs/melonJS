...
game.UI.ButtonUI = me.GUI_Object.extend({
    ...
    onClick : function (/* event */) {
        ...
        console.log("UI.ButtonUI[",this.label,"]: onClick: ");
...
game.UI.CheckBoxUI = me.GUI_Object.extend({
    ...
    init: function(x, y, texture, on_icon, off_icon, on_label, off_label) {
        ...
        console.log("UI.CheckBoxUI: ", on_label);
    ...
    onClick : function (/* event */) {
        ...
        console.log("UI.CheckBoxUI[",this.label_on,"]: onClick: ", this.isSelected);
